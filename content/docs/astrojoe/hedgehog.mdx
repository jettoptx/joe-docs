...
**HEDGEHOG** (Handshake Encrypted Delegated Gesture Envelope Handler Optical Gateway) is the AI gateway that powers AstroJOE's intelligence. It runs on the Jetson Orin Nano edge node and proxies requests to Grok 4.20 via the xAI API.
