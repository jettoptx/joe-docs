...
| <span style={{color: "#60a5fa"}}>**Orchestration**</span> | AstroJOE (Hermes v0.8.0, Docker), Workspace UI, AgenC Coordinator |
...
| Service | Role |
|---------|------|
| **AstroJOE** | Primary agent brain — Hermes v0.8.0 in Docker, Grok 4.20 via HEDGEHOG |
...
```
AgenC Coordinator
  ├── AstroJOE (primary brain, Hermes v0.8.0)
