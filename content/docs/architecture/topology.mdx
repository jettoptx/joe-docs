...
| <span style={{color: "#f43f5e"}}>**Edge Node**</span> | K3s, SpacetimeDB, HEDGEHOG, AARON, optional federation transport |
...
| **HEDGEHOG** | AI gateway — OpenAI-compatible REST API for agents, MCP stdio for IDEs |
