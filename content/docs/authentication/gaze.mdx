...
<video
  controls
  preload="metadata"
  className="w-full aspect-video rounded-lg border border-fd-border my-6"
  src="/videos/AGT_Intro_Learner.MP4"
>
  Your browser doesn't support HTML5 video.
  <a href="/videos/AGT_Intro_Learner.MP4">Download the video</a> instead.
</video>
