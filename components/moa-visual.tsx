...
export const NODES_DATA: Omit<Node, "x" | "y" | "vx" | "vy" | "pulse">[] = [
  ...
  { id: "matrix", label: "Matrix GW", group: "astrojoe", agt: "ENV", radius: 13, href: "/docs/astrojoe/matrix", description: "Optional federation transport for AstroJOE — not part of JettChat dual-mode core", subLabels: ["Conduit Homeserver", "nio Listener", "Optional Transport", "Federated Comms"], emo: 15, env: 70, cog: 15 },
